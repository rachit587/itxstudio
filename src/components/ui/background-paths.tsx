...
function FloatingPaths({ position }: { position: number }) {
  // Memoize paths so they're only computed once
  const paths = useMemo(() => 
  ...
  return (
    <div className="absolute inset-0 pointer-events-none" style={{ willChange: 'transform', contain: 'layout style paint' }}>
      <svg
...
export function BackgroundPaths() {
  return (
    <div className="absolute inset-0 z-0 bg-[#0a0a0a] overflow-hidden" style={{ contain: 'layout style paint' }}>
      {/* Subtle radial glow */}
